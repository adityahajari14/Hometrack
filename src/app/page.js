...
export default function Home() {
  return (
    <main className="bg-[#020202] text-white overflow-x-hidden">
      ...
      <section className="w-full py-12 sm:py-16 lg:py-20" id="insights">
        <div className="flex flex-col lg:flex-row items-center justify-center w-full gap-6 sm:gap-8 lg:gap-24 px-4 sm:px-6 lg:px-20">
          ...
          <div className="flex flex-col gap-6 sm:gap-8 lg:gap-12 w-full lg:w-1/2 px-0 sm:px-4 lg:px-8">
            <div>
              <h2 className="text-orange-600 text-xl sm:text-2xl lg:text-3xl font-dm-sans">Total Assets</h2>
              <h1 className="text-white text-3xl sm:text-4xl lg:text-6xl font-bold mt-2 sm:mt-3 lg:mt-4">$0 Billion</h1>
            </div>
            <hr className="border-t border-gray-600 mx-0 sm:mx-2" />

            <div>
              <h2 className="text-orange-600 text-xl sm:text-2xl lg:text-3xl font-dm-sans">Countries</h2>
              <h1 className="text-white text-3xl sm:text-4xl lg:text-6xl font-bold mt-2 sm:mt-3 lg:mt-4">0</h1>
            </div>
            <hr className="border-t border-gray-600 mx-0 sm:mx-2" />

            <div>
              <h2 className="text-orange-600 text-xl sm:text-2xl lg:text-3xl font-dm-sans">Assets</h2>
              <h1 className="text-white text-3xl sm:text-4xl lg:text-6xl font-bold mt-2 sm:mt-3 lg:mt-4">0</h1>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#020202] py-12 sm:py-16 lg:py-20 w-full" id="services">
        <div className="w-full px-4 sm:px-6 lg:px-20">
          <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-0 mb-8 sm:mb-12 lg:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold w-full lg:w-auto">
      ...
      <section className="bg-black/40 py-12 sm:py-16 lg:py-20 w-full" id="founder">
        <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-12 px-4 sm:px-6 lg:px-20 mb-8 sm:mb-12 lg:mb-12">
          <div className="w-full lg:w-1/2 px-0 sm:px-4 lg:px-0">
            <h2 className="text-2xl sm:text-3xl lg:text-5xl font-bold font-noto-sans mb-4 sm:mb-6 lg:mb-8">
              Meet our <span className="text-orange-600">Founder</span>
            </h2>
            <p className="text-sm sm:text-base lg:text-lg font-dm-sans leading-6 sm:leading-7 lg:leading-8 text-gray-300">
      ...
      <section className="bg-[#020202] py-12 sm:py-16 lg:py-20 w-full" id="safety-and-responsibility">
        <div className="w-full px-4 sm:px-6 lg:px-20">
          <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-0 mb-8 sm:mb-12 lg:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold w-full lg:w-auto">
      ...
      <section className="bg-[#020202] py-12 sm:py-16 lg:py-20 w-full" id="testimonials">
        <div className="w-full px-4 sm:px-6 lg:px-20">
          <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-0 mb-8 sm:mb-12 lg:mb-12">
      ...
      <section className="bg-[#020202] py-12 sm:py-16 lg:py-20 w-full" id="contact-us">
        <ContactCard />
      </section>
