...
export default function Hero() {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center w-full h-full relative z-10 px-4 sm:px-6 lg:px-8 gap-6 sm:gap-8 lg:gap-12 py-16 sm:py-20 lg:py-0">
      <div className="w-full lg:w-1/2 px-0 sm:px-4 lg:px-8">
        <h1 className="text-2xl sm:text-3xl lg:text-5xl text-white font-noto-sans font-bold leading-tight">
          Where <span className="italic text-orange-600">Expertise</span> Meets
        </h1>
        <h1 className="text-2xl sm:text-3xl lg:text-5xl text-white font-noto-sans font-bold mb-4 sm:mb-6 lg:mb-6 mt-1 sm:mt-2 leading-tight">
          Excellence
        </h1>
      ...
      <div className="w-full lg:w-1/2 bg-black/58 rounded-md py-6 sm:py-8 lg:py-8 flex flex-col mx-0 lg:mx-8 px-4 sm:px-6 lg:px-8 max-w-full">
        <h2 className="text-white font-dm-sans text-lg sm:text-2xl lg:text-3xl mb-4 sm:mb-6">
        ...
        <div className="flex flex-col gap-3 sm:gap-4">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4"> 
            <div className="w-full sm:w-1/2">
              ...
              <input
                type="text"
                className="w-full py-2 px-3 rounded-md bg-black/20 placeholder:text-[#9E9E9E] text-white text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-orange-600"
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <div className="w-full sm:w-1/2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full py-2 px-3 rounded-md bg-black/20 text-white text-sm sm:text-base cursor-pointer placeholder:text-[#9E9E9E] focus:outline-none focus:ring-2 focus:ring-orange-600"
                  style={{
                    colorScheme: 'dark',
                    appearance: 'none',
                  }}
            ...
            <div className="w-full sm:w-1/2">
              ...
              <select className="w-full py-2 px-3 rounded-md bg-black/20 text-[#9E9E9E] text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-orange-600">
