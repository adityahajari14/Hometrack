      ...
      <div className="bg-[#020202] rounded-lg shadow-[0px_0px_60px_30px_rgba(0,0,0,0.03)] overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] xl:grid-cols-[491px_1fr]">
                ...
                <div className="flex flex-col gap-6 sm:gap-8 lg:gap-10 xl:gap-12 mt-8 sm:mt-12 lg:mt-16 xl:mt-24">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 lg:gap-6">
                    <Image
                      ...
                      className="shrink-0"
                    />
                    <span className="font-dm-sans text-xs sm:text-sm lg:text-base">+971 4 263 5775</span>
                  </div>
          ...
          <div className="p-6 sm:p-8 lg:p-10 xl:p-15 flex flex-col justify-center gap-6 sm:gap-8 lg:gap-10 xl:gap-12">
            <div className="flex flex-col gap-5 sm:gap-6 lg:gap-8 xl:gap-10">
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="bg-transparent border-b border-gray-700 pb-2 sm:pb-3 text-[#434343] placeholder:text-[#434343] font-dm-sans text-sm sm:text-base lg:text-lg focus:outline-none focus:border-white transition-colors"
                />
              </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <textarea
                ...
                rows={4}
                className="bg-transparent border-b border-gray-700 pb-2 sm:pb-3 text-[#8a8a8a] placeholder:text-[#8a8a8a] font-dm-sans text-sm sm:text-base lg:text-lg focus:outline-none focus:border-white transition-colors resize-none"
              />
            </div>
